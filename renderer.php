...
class block_migrate_users_renderer extends plugin_renderer_base {
    public function users_form(moodle_url $formtarget, $userfrom, $userto, $courseid) {
        $content = html_writer::start_tag('form', array('class'=>'userfrom', 'method'=>'get', 'action'=>$formtarget));
        ...
        $content .= html_writer::empty_tag('input', array('type'=>'submit', 'value'=>s(get_string('migrate', 'block_migrate_users'))));
